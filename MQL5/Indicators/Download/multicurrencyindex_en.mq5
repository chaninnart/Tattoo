...
input color Color_AUD = clrYellow;       // AUD line color
input color Color_CAD = clrLawnGreen;           // CAD line color
input color Color_CHF = clrWhite;        // CHF line color
input color Color_EUR = clrDodgerBlue;         // EUR line color
input color Color_GBP = clrAqua;              // GBP line color
input color Color_NZD = clrOrange;             // NZD line color
input color Color_USD = clrGreen;            // USD line color
input color Color_JPY = clrRed;           // JPY line color
