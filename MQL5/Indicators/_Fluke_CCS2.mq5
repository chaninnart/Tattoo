...
int rsi_period       =   9; // period RSI
int MACD_fast        =   5; // period MACD_fast
int MACD_slow        =  34; // period MACD_slow
int stoch_period_k   =   8; // period Stochastic %K
int stoch_period_sma =   5; // period of smoothing for Stochastics %K
int shiftbars        = 500; // number of bars for calculating the indicator
...
int                wid_main =         2; //Lines width for current chart
